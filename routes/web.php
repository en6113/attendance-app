...
Route::middleware('auth:web', 'verified')->group(function () {
    ...
    Route::get('/attendance/detail/{attendanceRecord}', [AttendanceController::class, 'show'])->name('attendance.show');
    Route::post('/attendance/detail/{attendanceRecord}', [AttendanceController::class, 'store']);
    ...
    Route::get('/application/{attendanceRecord}', [AttendanceController::class, 'show']);
...
Route::middleware('auth:web', 'admin')->group(function () {
    ...
    Route::get('/admin/attendance/{attendanceRecord}', [AdminAttendanceController::class, 'show'])->name('admin.attendance.show');
    Route::post('/admin/attendance/{attendanceRecord}', [AdminAttendanceController::class, 'update']);
    ...
    Route::get('/stamp_correction_request/approve/{attendanceCorrectRequest}', [AdminApplicationController::class, 'show']);
    Route::post('/stamp_correction_request/approve/{attendanceCorrectRequest}', [AdminApplicationController::class, 'update']);
});
